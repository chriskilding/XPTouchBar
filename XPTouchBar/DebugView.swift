...
struct DebugView: View {
    ...
    var formattedFlaps: String {
        let n = Measurement(value: flaps, unit: UnitAngle.degrees)
        return n.formatted()
    }
    ...
    var body: some View {
        Form {
            Section(header: Text("What X-Plane sees")) {
                ...
                .tint(Color.red)
                HStack {
                    Stepper("Flaps \(formattedFlaps)", value: $flaps, in: 0...30, step: 10)
                }
            }
        }
    }
